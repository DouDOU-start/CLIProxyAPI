                    ...
                    <SectionGrid>
                      <FieldAnchor fieldId="rmEmail">
                        <Input
                          ...
                          type="email"
                          placeholder={t(
                            'config_management.visual.sections.remote.email_placeholder'
                          )}
                          value={values.rmEmail}
                          onChange={(e) => onChange({ rmEmail: e.target.value })}
                          disabled={disabled}
                        />
                      </FieldAnchor>
                      <FieldAnchor fieldId="rmPassword">
                        <Input
                          label={t('config_management.visual.sections.remote.password')}
                          type="password"
                          autoComplete="new-password"
                          placeholder={t(
                            'config_management.visual.sections.remote.password_placeholder'
                          )}
                          hint={t('config_management.visual.sections.remote.password_hint')}
                          value={values.rmPassword}
                          onChange={(e) => onChange({ rmPassword: e.target.value })}
                          disabled={disabled}
                        />
                      </FieldAnchor>
                    </SectionGrid>
